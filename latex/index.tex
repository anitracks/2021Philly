...
Written by Seth Mc\+Neill ~\newline
 Managed by David Mc\+Neill and Stacy Butler\hypertarget{index_autotoc_md1}{}\doxysection{Usage}\label{index_autotoc_md1}
\hypertarget{index_autotoc_md2}{}\doxysubsection{clean\+Count Outcomes.\+py}\label{index_autotoc_md2}
...
\end{DoxyCode}
 \hypertarget{index_autotoc_md3}{}\doxysubsection{clean\+Plaintiffs.\+py}\label{index_autotoc_md3}
The following is an example of running the \mbox{\hyperlink{cleanPlaintiffs_8py}{clean\+Plaintiffs.\+py}} script from inside the src folder. 
\begin{DoxyCode}{0}
\DoxyCodeLine{python .\(\backslash\)cleanPlaintiffs.py ..\(\backslash\)..\(\backslash\)data\(\backslash\)MC\_specialreport\_limiteddaterange\_Nov6.csv .\(\backslash\)20215121490-\/comparisonMatrix.pkl -\/e 0.1}

\end{DoxyCode}
\hypertarget{index_autotoc_md4}{}\doxysection{Progress}\label{index_autotoc_md4}
\hypertarget{index_autotoc_md5}{}\doxysubsection{2021 March 18}\label{index_autotoc_md5}
The code in \mbox{\hyperlink{cleanCountOutcomes_8py}{clean\+Count\+Outcomes.\+py}} reads in a csv file from the Philidelphia court system, cleans, collates, and prints out the outcomes column.\hypertarget{index_autotoc_md6}{}\doxysubsubsection{Example output}\label{index_autotoc_md6}
