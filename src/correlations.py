"""!
 ...
 @brief Data analysis testing
 @details This finds some correlations between plaintiffs and outcomes. This 
 script was used for testing some ideas.
...
def main():
    ...
    for index, value in plaintiffs.items():
        nFind = len(df[df['Plaintiff Name(s)'].str.contains(index, case=False)])
        if nFind != value:
